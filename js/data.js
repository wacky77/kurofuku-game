...
const NEEDS = {
  heal:  { label: '癒されたい',       need: 'heal',
    hints: ['**深いため息**をついている…', '**肩を揉みながら**席についた。疲れている様子だ', '「今週は休みがなくてね…」と**遠い目**をしている', 'おしぼりを顔に当てて動かない…**相当お疲れ**のようだ'] },
  talk:  { label: '盛り上がりたい',   need: 'talk',
    hints: ['「何か面白い話ある？」と**身を乗り出して**いる', '口数が多く、**話し相手を探している**様子だ', '「最近さぁ、聞いてよ〜」と**話したくてうずうず**している', 'キョロキョロと**賑やかな席**を羨ましそうに見ている'] },
  price: { label: 'とことん飲みたい', need: 'price',
    hints: ['**ボトル棚の高い段**ばかり眺めている…', '「今日は財布が温かいんだ」と**ニヤリ**と笑った', '**腕時計がキラリと光る**。金離れが良さそうだ', 'メニューを見ずに「**いいの持ってきてよ**」と言っている'] },
  smile: { label: '元気をもらいたい', need: 'smile',
    hints: ['**うつむき気味**で、どこか元気がない…', '「最近いいことなくてさ」と**苦笑い**している', '沈んだ表情。**パッと明るくしてほしそう**だ', 'スマホを見てはため息…**励ましが必要**そうだ'] },
};
...
const CUSTOMER_TYPES = [
  { id: 'salary',   title: 'サラリーマン', emoji: '🧑‍💼', bg: '#1e2740', bg2: '#33436e', budgets: [35000, 40000, 55000], needBias: 'talk',
    ...
    hints: { heal: '「今月も詰め込みすぎてね…」と**肩を回して**ため息をついた',
      talk: '「聞いてくれよ、うちの上司がさ」と**身を乗り出して**話し始めた',
      price: '「たまにはパーッと使わせてくれ」と**カードを景気よく**取り出した',
      smile: '「疲れた顔してるだろ…」と**苦笑い**で肩を落としている' } },
  { id: 'young',    title: '若手社員',     emoji: '👔',   bg: '#24303a', bg2: '#3a4e5e', budgets: [20000, 35000],        needBias: 'smile',
    lines: ['先輩に連れられて来ました！', 'こういうお店、緊張しますね…'],
    hints: { heal: '慣れないスーツ姿で、**背中を丸めて**縮こまっている',
      talk: '「先輩によく怒られるんです…」と**話を聞いてほしそうに**そわそわしている',
      price: '財布の中身を気にしながら**メニューをそっと**見ている',
      smile: '緊張でこわばった顔に、**元気づけてほしそうな**視線を送ってくる' } },
  { id: 'bucho',    title: '部長さん',     emoji: '🕴️',   bg: '#26242e', bg2: '#403c50', budgets: [55000, 70000],        needBias: 'price',
    lines: ['今日は無礼講だ！パーッといこう', 'いいボトル入れちゃおうか'],
    hints: { heal: '「部下の尻拭いで参ったよ…」と**ネクタイを緩めて**天井を仰いだ',
      talk: '「今日は無礼講だ！」と**声を張って**周りを盛り上げようとしている',
      price: '「いいのを開けてくれ」と**指を鳴らして**ボーイを呼んだ',
      smile: '部下には見せない**くだけた笑顔**をこちらに向けてくる' } },
  { id: 'oyakata',  title: '建設の親方',   emoji: '👷',   bg: '#3a2a1e', bg2: '#5c4230', budgets: [35000, 40000, 55000], needBias: 'price',
    lines: ['今日は現場がうまくいってな！', 'パーッと飲むぞ〜！'],
    hints: { heal: '日焼けした顔に**疲労の色**が滲んでいる。現場は長かったようだ',
      talk: '「今日の現場の話、聞いてくれや」と**豪快に**話しかけてきた',
      price: '「今日は懐が温かいぞ」と**分厚い財布**をポンと叩いた',
      smile: 'ぶっきらぼうな顔の奥に**元気をもらいたそうな**照れが見える' } },
  { id: 'doctor',   title: 'お医者さん',   emoji: '🧑‍⚕️', bg: '#1e3236', bg2: '#335056', budgets: [55000, 70000],        needBias: 'heal',
    lines: ['オペ続きで疲れててね…', 'ゆっくりさせてもらうよ'],
    hints: { heal: '「オペ続きでね…」と**目の下のクマ**が濃い',
      talk: '白衣を脱いだ途端、**饒舌に**世間話をしたがっている',
      price: '「今日は特別なボトルを」と**リストの上段**を指差した',
      smile: '険しい顔つきの奥に、**ふっと緩む瞬間**を探しているようだ' } },
  { id: 'lawyer',   title: '弁護士',       emoji: '⚖️',   bg: '#22203c', bg2: '#39366a', budgets: [55000, 70000],        needBias: 'talk',
    lines: ['久々に息抜きに来たよ', '君と話すと落ち着くね'],
    hints: { heal: '「今日はキツい依頼人でね…」と**こめかみ**を押さえている',
      talk: '「反論するのが商売でね」と**理屈っぽく**話したがる様子',
      price: '「勝訴祝いだ」と**ワインリストを**堂々と広げた',
      smile: '普段は無表情、でも**ふとした瞬間の笑み**を求めていそうだ' } },
  { id: 'itceo',    title: 'IT社長',       emoji: '🧑‍💻', bg: '#1e3038', bg2: '#2e5866', budgets: [55000, 70000],        needBias: 'price',
    lines: ['最近IPOしてね、景気いいよ', '細かいことは気にしない主義でね'],
    hints: { heal: '「資金調達の山場でね…」と**モニター疲れの目**をこすっている',
      talk: '「うちのサービスの話、聞いてよ」と**早口で**語り出しそうだ',
      price: '「細かい計算はいいから」と**上のクラス**を即決した',
      smile: 'スマホばかり見ていた顔が、ふと**明るい話題**を求めている' } },
  { id: 'band',     title: 'バンドマン',   emoji: '🎸',   bg: '#2a1e34', bg2: '#463056', budgets: [20000, 35000],        needBias: 'smile',
    lines: ['ライブ終わりでテンション高いっす！', '盛り上がっていこうぜ！'],
    hints: { heal: 'ライブ帰りで**声が枯れて**いる。実は結構くたびれている様子',
      talk: '「今日のライブの話、聞いてくれよ」と**目を輝かせて**いる',
      price: '「今日は太っ腹にいくぜ」と**チェーンを揺らして**笑った',
      smile: '「盛り上げてくれよ！」と**テンション高く**手を叩いている' } },
  { id: 'prof',     title: '大学教授',     emoji: '🎓',   bg: '#2e2620', bg2: '#4a3a2e', budgets: [35000, 40000, 55000], needBias: 'talk',
    lines: ['面白い話を聞かせてくれるかい？', 'たまには俗世で息抜きだ'],
    hints: { heal: '「論文の締切でね…」と**眼鏡を外して**目頭を揉んでいる',
      talk: '「君の意見も聞きたいね」と**議論好きな目**で見つめてくる',
      price: '「たまにはいい酒を」と**年代物のボトル**を指差した',
      smile: '堅い話ばかりの日常に、**ちょっとした笑い**を欲しがっている' } },
  { id: 'chef',     title: '板前さん',     emoji: '🍣',   bg: '#301e22', bg2: '#54303a', budgets: [35000, 40000, 55000], needBias: 'heal',
    lines: ['店じまい後の一杯が効くね', '静かに飲ませてもらうよ'],
    hints: { heal: '「一日中立ちっぱなしでね」と**腰をとんとん**叩いている',
      talk: '「今日のいい魚の話、聞くかい？」と**目を細めて**語りたがる',
      price: '「たまにはいいものを」と**上物のボトル**をそっと指差した',
      smile: '無口な職人顔の奥に、**ふっと和らぐ瞬間**を待っていそうだ' } },
  { id: 'farmer',   title: '農家のおやじ', emoji: '👨‍🌾', bg: '#1e2e22', bg2: '#305038', budgets: [20000, 35000],        needBias: 'heal',
    lines: ['たまの贅沢だでな〜', '都会は落ち着かんわい'],
    hints: { heal: '「今日は畑仕事で疲れたわい」と**腰を叩きながら**座った',
      talk: '「都会の話、聞かせてくれや」と**人懐っこく**話しかけてくる',
      price: '「今年は豊作だでな」と**厚い封筒**をポンと叩いた',
      smile: '日に焼けた顔に、**照れくさそうな笑み**を浮かべている' } },
  { id: 'comedian', title: 'お笑い芸人',   emoji: '🎤',   bg: '#331e2a', bg2: '#5c3048', budgets: [35000, 40000, 55000], needBias: 'smile',
    lines: ['どう、オレ面白い？', '笑わせてくれる子がいいなァ'],
    hints: { heal: '舞台の疲れか、**笑顔の奥**にどっと疲れが見える',
      talk: '「オレの新ネタ、聞いてくれよ」と**間合いを計りながら**話しかけてきた',
      price: '「賞レース獲ったからな」と**気前よく**ボトルを注文した',
      smile: '「オレを笑わせられるか？」と**挑発するような目**で見てくる' } },
  { id: 'trader',   title: '証券マン',     emoji: '📈',   bg: '#1e2e2a', bg2: '#2e5048', budgets: [40000, 55000, 70000], needBias: 'price',
    lines: ['今日は相場で勝ったからな！', 'パーッと使わせてもらうよ'],
    hints: { heal: '「今日は乱高下でクタクタだよ…」と**眉間を揉んで**いる',
      talk: '「相場の話、聞いてくれよ」と**早口でまくし立て**始めた',
      price: '「今日は大勝ちしたからな」と**札束の厚み**を自慢げに見せた',
      smile: 'ピリピリした顔の奥に、**息抜きを求めている**気配がある' } },
  { id: 'sensei',   title: '先生（士業）', emoji: '🖋️',   bg: '#2a2620', bg2: '#4a4230', budgets: [40000, 55000],        needBias: 'talk',
    lines: ['顧問先の接待でね', 'ま、一杯やりましょう'],
    hints: { heal: '「顧問先の対応で参ったよ」と**肩をほぐして**いる',
      talk: '「今日は世間話をしたい気分でね」と**話し好きな顔**を見せる',
      price: '「接待だからね、いいものを」と**上のランク**を指名した',
      smile: '堅苦しい肩書の裏で、**くだけた表情**を見せたがっている' } },
  // --- 増枠ペルソナ ---
  { id: 'teacher',  title: '学校の先生',   emoji: '📚',   bg: '#1e2a34', bg2: '#324a5c', budgets: [35000, 40000, 55000], needBias: 'heal',
    lines: ['たまには羽を伸ばさないとね', '生徒には内緒だよ？'],
    hints: { heal: '「今日も生徒指導でくたびれてね…」と**深いため息**をついた',
      talk: '「たまには大人の会話がしたくてね」と**話し相手を探して**いる',
      price: '「今日はボーナスが入ってね」と**珍しく上等な**注文をした',
      smile: '教壇では見せない**素の笑顔**を探しているようだ' } },
  { id: 'police',   title: '警察官',       emoji: '👮',   bg: '#1e2438', bg2: '#2e3a66', budgets: [35000, 40000, 55000], needBias: 'talk',
    lines: ['非番の日くらいはな', '固い仕事だから息抜きさ'],
    hints: { heal: '「非番でも気が抜けなくてね」と**肩の張り**をもみほぐしている',
      talk: '「たまには誰かに話を聞いてほしくてね」と**言葉少なに**呟いた',
      price: '「今日は羽目を外すぞ」と**財布の紐を緩めて**注文した',
      smile: '硬い表情の裏に、**和ませてほしそうな**空気が見える' } },
  { id: 'pilot',    title: 'パイロット',   emoji: '✈️',   bg: '#1e2e38', bg2: '#2e5066', budgets: [55000, 70000],        needBias: 'price',
    lines: ['フライト明けでね', '世界を飛び回ってるよ'],
    hints: { heal: '「長時間フライトの後でね」と**首を回して**ほぐしている',
      talk: '「世界を飛び回る話、聞くかい？」と**楽しげに**語りたがる',
      price: '「フライト手当が入ったのでね」と**上級ボトル**を即決した',
      smile: '制服の疲れも見せず、**朗らかな空気**を求めている' } },
  { id: 'fisher',   title: '漁師',         emoji: '🎣',   bg: '#1e2e30', bg2: '#2e5054', budgets: [35000, 40000, 55000], needBias: 'price',
    lines: ['今日は大漁だったぞ！', '海の男は豪快でな！'],
    hints: { heal: '「今日は時化で大変だったぞ」と**日焼けした肩**をほぐしている',
      talk: '「大漁の話、聞いてくれ！」と**海の男らしく**語り出した',
      price: '「今日は大漁だったからな」と**分厚い札束**を見せびらかした',
      smile: '豪快な見た目の奥に、**気さくな笑顔**を求めている様子' } },
  { id: 'designer', title: 'デザイナー',   emoji: '🎨',   bg: '#2e1e34', bg2: '#4a3056', budgets: [35000, 40000, 55000], needBias: 'smile',
    ...
    hints: { heal: '「徹夜続きでね…」と**目元を押さえて**座った',
      talk: '「センスの話、聞いてくれる？」と**熱っぽく**語りたがる',
      price: '「案件が決まったお祝いにね」と**おしゃれなボトル**を指差した',
      smile: '「センスいい子と盛り上がりたいな」と**茶目っ気のある目**を見せる' } },
  { id: 'realtor',  title: '不動産社長',   emoji: '🏠',   bg: '#332818', bg2: '#5c4a1e', budgets: [55000, 70000],        needBias: 'price',
    lines: ['物件がポンと売れてね', '景気のいい話をしようや'],
    hints: { heal: '「物件の交渉で疲れたよ」と**首筋をもみながら**座った',
      talk: '「今日成約した話、聞いてくれよ」と**得意げに**話しかけてきた',
      price: '「今日はでかい契約が決まってね」と**分厚い封筒**を軽く叩いた',
      smile: '商談用の作り笑いではなく**本物の笑顔**を求めているようだ' } },
  { id: 'dentist',  title: '歯医者さん',   emoji: '🦷',   bg: '#1e3234', bg2: '#335254', budgets: [55000, 70000],        needBias: 'heal',
    lines: ['細かい仕事で肩が凝ってね', 'のんびりさせてもらうよ'],
    hints: { heal: '「細かい仕事で肩が凝ってね」と**肩をとんとん**叩いている',
      talk: '「今日は世間話がしたくてね」と**穏やかに**話しかけてきた',
      price: '「たまにはいい酒を」と**上のクラス**をそっと指名した',
      smile: '白衣の下の疲れた顔に、**ふっと緩む笑み**を探しているようだ' } },
  { id: 'actor',    title: '俳優',         emoji: '🎬',   bg: '#301e2c', bg2: '#54304c', budgets: [55000, 70000],        needBias: 'talk',
    lines: ['撮影あがりで来たんだ', '面白い話、聞かせてよ'],
    hints: { heal: '「撮影で体力使い果たしたよ…」と**目を閉じて**座っている',
      talk: '「今日の役の話、聞いてくれる？」と**熱を込めて**語り出した',
      price: '「主演祝いだ」と**豪華なボトル**を華やかに指名した',
      smile: 'カメラの前とは違う、**素顔の笑顔**を見せたがっている' } },
  { id: 'athlete',  title: 'スポーツ選手', emoji: '⚾',    bg: '#1e2e22', bg2: '#2e5038', budgets: [40000, 55000, 70000], needBias: 'smile',
    lines: ['シーズンオフだからな！', '元気な子と飲みたいね'],
    hints: { heal: '「今日は追い込みすぎてね…」と**筋肉痛の肩**をさすっている',
      talk: '「今シーズンの話、聞いてくれよ！」と**元気よく**話しかけてきた',
      price: '「契約更改でね」と**気前よく**上のボトルを注文した',
      smile: '「元気な子と盛り上がりたいね！」と**弾んだ声**で言っている' } },
  { id: 'mayor',    title: '地元議員',     emoji: '🎗️',   bg: '#2a2018', bg2: '#4a3a22', budgets: [55000, 70000],        needBias: 'talk',
    lines: ['地元の皆さんのおかげでね', 'ま、堅い話は抜きで'],
    hints: { heal: '「陳情続きで参ったよ…」と**こめかみ**を押さえている',
      talk: '「地元の話、聞いてくれるかい？」と**如才なく**話しかけてきた',
      price: '「後援会の集まりの後でね」と**上等なボトル**を指名した',
      smile: '選挙用の笑顔ではない、**素の笑顔**を見せたがっている' } },
  { id: 'novelist', title: '小説家',       emoji: '✍️',   bg: '#241e2e', bg2: '#3c3050', budgets: [35000, 40000, 55000], needBias: 'heal',
    lines: ['筆が進まなくてね…', '静かに一杯やりたいんだ'],
    hints: { heal: '「筆が進まなくてね…」と**うつむき加減**で座っている',
      talk: '「聞いてほしい話があってね」と**言葉を選びながら**話しかけてきた',
      price: '「印税が入ったのでね」と**珍しく上等な**ボトルを指名した',
      smile: '沈んだ表情の奥に、**明るい話題**を欲しがっている様子' } },
  { id: 'barber',   title: '理容師',       emoji: '💈',   bg: '#2e2222', bg2: '#503a3a', budgets: [20000, 35000],        needBias: 'smile',
    lines: ['店じまいして来たよ', '賑やかなのが好きでね'],
    hints: { heal: '「一日中鋏を握りっぱなしでね」と**手首をほぐして**いる',
      talk: '「お客さんの話、聞いてほしくてね」と**世間話好きな顔**を見せる',
      price: '「今月は指名が多くてね」と**気前よく**注文した',
      smile: '「賑やかな方が好きでね」と**明るい笑顔**を求めている' } },
  { id: 'driver',   title: 'タクシー運転手',emoji: '🚕',  bg: '#2e2a18', bg2: '#4e461e', budgets: [20000, 35000],        needBias: 'heal',
    lines: ['夜勤明けでクタクタさ', 'ちょっと休ませてくれ'],
    hints: { heal: '「夜勤明けでクタクタさ」と**目をこすりながら**座った',
      talk: '「お客さんの面白い話、聞くかい？」と**運転手らしく**話したがる',
      price: '「今日は稼ぎがよくてね」と**財布を景気よく**開いた',
      smile: '疲れた顔の奥に、**元気をもらいたそうな**気配がある' } },
  { id: 'youtuber', title: 'ユーチューバー',emoji: '📱',  bg: '#2e1e28', bg2: '#503046', budgets: [35000, 40000, 55000], needBias: 'smile',
    ...
    hints: { heal: '「編集続きで目がしょぼしょぼでね」と**目元をこすって**いる',
      talk: '「今日の動画の話、聞いてよ！」と**テンション高く**話しかけてきた',
      price: '「バズって広告収入が入ってね」と**気前よく**ボトルを指名した',
      smile: '「楽しい子と盛り上がりたいっす！」と**カメラ越しの笑顔**そのままに言う' } },
];
